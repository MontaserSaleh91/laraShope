        ...
        @endif
            ...
            <div class="card">
                ...
                <div class="card-body">
                   <div class="row">
                        <div class="col-md-12">
                            <form action="{{route('tags')}}" method="POST">@csrf
                                <div class="form-row align-items-center">
                                
                                
                               
                                    <div class="col-auto">
                                            <label class="sr-only" for="tag">Tag Name</label>
                                            <input type="text" class="form-control mb-2" id="tag" name="tag" autocomplete="off" placeholder="Tag Name" required>
                                    </div>
                                <div class="col-auto">
                                    <button type="submit" class="btn btn-primary mb-2">Add New Tag</button>
                                </div>
                                </div>
                            </form>
                        </div>
                       ...
                       @foreach ($tags as $tag)
                           ...
                           <div class="col-lg-3 close" >
                               ...
                               <div class="alert alert-primary" role="alert">
                                    ...
                                    <a href="" data-toggle="modal" onclick="editData({{$tag->id}})" 
                                ...
                                <form action="" id="editForm" method="POST">{{ csrf_field()}}
                                      <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                                    ...
                                                    <div class="col-auto">
                                                            <label class="sr-only" for="tag">Tag Name</label>
                                                            <input type="text" autocomplete="off" class="form-control mb-2"  name="tag" placeholder="Tag Name" required>
                                                        </div>
                                          </div>
                                          <div class="modal-footer">
                                              <center>
